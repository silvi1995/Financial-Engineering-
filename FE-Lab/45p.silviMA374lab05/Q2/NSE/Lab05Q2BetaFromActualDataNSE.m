Y1 = load('ACCLtd.txt');
Y2 = load('AdaniPortsAndSpecialEconomicZone.txt');
Y3 = load('AmbujaCementsLtd.txt');
Y4 = load('AshokLeylandLtd.txt');
Y5 = load('AsianPaintsLtd.txt');
Y6 = load('AurobindoPharmaLtd.txt');
Y7 = load('AxisBankLtd.txt');
Y8 = load('BankOfBaroda.txt');
Y9 = load('BankOfIndia.txt');
Y10 = load('Bosch.txt');
